...
tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["Dashboard", "Backtesting", "Paper Trading", "Strategy", "News/Prediction", "AI Assistant"])
...
# Add this after the current imports at the top
try:
    from live_data_manager import LiveDataManager
    LIVE_DATA_MANAGER_AVAILABLE = True
except ImportError:
...
# Add to imports section (around line 24-30)
import uuid
from datetime import datetime, timedelta, timezone
import os
import sys
...
# Add this at the end of the file, before the final if statement
with tab6:
