...
from trading_bot.utils.market_data import calculate_iv_rank, get_upcoming_events
from trading_bot.utils.option_utils import get_option_expiration, get_atm_strike
from trading_bot.utils.risk_management import position_size_by_risk
    ...
    def scan_for_opportunities(self, symbols: List[str]) -> List[Dict]:
        ...
        for symbol in symbols:
            try:
                ...
                expiration_date = get_option_expiration(option_chain, target_days)
