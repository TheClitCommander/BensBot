-- AppleScript to create a desktop shortcut for the Trading Bot Dashboard on port 8080
...
tell application "Finder"
	...
	activate
	do script \"cd " & projectPath & " && ./run_dashboard_8080.command\"
end tell"
	
	-- Save the script as an application on the desktop
	set appFile to (desktopPath & "Trading Dashboard (8080).app")
	...
	display dialog "Trading Dashboard (8080) shortcut has been created on your desktop." buttons {"OK"} default button "OK"
end tell 