...
type DevTabType = 'System Monitor' | 'Performance Stats' | 'System Config';

const Developer: React.FC = () => {
  const [activeDevTab, setActiveDevTab] = useState<DevTabType>('System Monitor');

  // Tabs available in the developer section
  const devTabs: DevTabType[] = [
    'System Monitor',
    'Performance Stats',
    'System Config'
  ];
