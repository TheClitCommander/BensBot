-- AppleScript to create a desktop shortcut for the Trading Bot Dashboard
...
tell application "Finder"
	...
	activate
	do script \"cd " & projectPath & " && ./run_dashboard.command\"
end tell"
	
	-- Save the script as an application on the desktop
	set appFile to (desktopPath & "Trading Dashboard.app")
	...
	display dialog "Trading Dashboard shortcut has been created on your desktop." buttons {"OK"} default button "OK"
end tell 